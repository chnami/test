...
public class FileOutputter implements Outputter{
	...
	public FileOutputter() {
		System.out.println("여기는 FileOutpuuter 생성자입니다.");
	}

	@Override
	public void output(String message) throws IOException {
		System.out.println("여기는 FileOutpuuter.java의 output() 입니다.");
	...
	public void setFilePath(String filePath) {
		...
		System.out.println("여기는 FileOuputter.java의 setFilePath() 입니다.");
